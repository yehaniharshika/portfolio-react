...
export const Skills = () => {
  ...
  const technologies = [
    ...
    {
      name: "Bootstrap",
      icon: <SiBootstrap className="w-10 h-10 text-purple-600" />,
      category: "frontend",
    },
    {
      name: "React",
    ...
    {
      name: "Vite",
      icon: <SiVite className="w-10 h-10 text-teal-500" />,
      category: "frontend",
    },
    {
      name: "JQuery",
      icon: <SiJquery className="w-10 h-10 text-orange-500" />,
      category: "frontend",
    },
    {
      name: "Flask",
      icon: <SiFlask className="w-10 h-10 text-red-400" />,
      category: "frontend",
    },
    ...
    {
      name: "Spring Boot",
      icon: <SiSpring className="w-10 h-10 text-green-500" />,
      category: "backend",
    },
    ...
    {
      name: "Firebase",
      icon: <SiFirebase className="w-10 h-10 text-orange-500" />,
      category: "database",
    },

    {
      name: "React Native",
      icon: <TbBrandReactNative className="w-10 h-10 text-blue-500" />,
      category: "mobile",
    },
    {
      name: "Flutter",
    ...
    {
      name: "Git",
      icon: <FaGitAlt className="w-10 h-10 text-orange-500" />,
      category: "other",
    },
    {
      name: "Docker",
    ...
    {
      name: "Figma",
      icon: <SiFigma className="w-10 h-10 text-purple-500" />,
      category: "other",
    },
    {
      name: "Postman",
      icon: <SiPostman className="w-10 h-10 text-orange-600" />,
      category: "other",
    },
    {
      name: "VSCode",
      icon: <VscVscode className="w-10 h-10 text-blue-400" />,
      category: "other",
    },
    {
      name: "IntelliJ",
      icon: <SiIntellijidea className="w-10 h-10 text-red" />,
      category: "other",
    },
    {
      name: "WebStorm",
      icon: <SiWebstorm className="w-10 h-10 text-green-600" />,
      category: "other",
    },
    {
      name: "Android Studio",
      icon: <FaAndroid className="w-10 h-10 text-green-300" />,
      category: "other",
    },
  ];
    ...
    <section id="skills" className="py-20 bg-white dark:bg-gray-900 w-full">
      <div className="container mx-auto px-4 md:px-0 text-center">
        ...
        <p
          ...
          style={{ fontFamily: "Montserrat, sans-serif" }}
        >
          I have experience developing software using cutting-edge technologies,
          ensuring high-quality solutions tailored to meet business needs.
        </p>

        {/* Skill Category Buttons */}
        <div className="flex flex-wrap justify-center mt-6 gap-3 p-1">
          {["frontend", "backend", "database", "mobile", "other"].map(
            (category) => (
              <button
                key={category}
