...
import VehicoreImage from "../assets/vehicore.jpg";
...
export const Projects = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      link: "https://github.com/yehaniharshika/VehiCore.git",
      category: "web",
    },
  ];
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  ...
                  <span
                    className="absolute inset-0 border-2 border-[#00cec9] rounded opacity-0 hover:opacity-100 transition-opacity duration-300"
